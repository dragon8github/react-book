...
![](/assets/   c7c9fc74-32ea-45a3-9f14-20293a081b8fimport.png)
...
在 React 中，组件之间的数据通讯几乎只能依赖于属性（props）的传递。
...
一个常见的场景是：控件绑定着 redux 的状态，并且我们监听数据的变化。当数据进行变化的时候，我们更新UI即可。

---

### Reduce是什么？

![](/assets/ 4c8b2b5d-72ad-4bc9-9b6f-2a7630c9e90aimport.png)
...
这里的 Reduce 是一个函数，正确来说，它就像一个仓库管理员。

它是创建仓库的关键因素，我们来看一段实战代码：
